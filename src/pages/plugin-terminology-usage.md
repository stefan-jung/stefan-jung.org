...
**org.jung.terminology** ships a sample project which shows how to create terminology concepts and how to use the transformations to create termchecker files, termbrowser, and so forth.

1. Open the DITA-OT project file `org.jung.terminology/samples/terminology.xml` in Oxygen XML. 
    If you don't know what a DITA-OT project file is, read [dita-ot.org - Publishing with project files](https://www.dita-ot.org/dev/topics/using-project-files).
2. continue here
